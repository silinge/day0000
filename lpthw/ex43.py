...
class Death(Scene):
    quips = [
        ...
        "you mon would be pround ... if she were smarter.",
        "Such a luser.",
...
class CentralCorridor(Scene):
    def enter(self):
        ...
        your entire crew. You are the last surviving member and your last mission is to get
        the neutron destruct bomb from the Weapons Armory, put it in the bridge, and blow
        the ship up after getting into an escape pod. You're running down the central corridor
        to the Weapons Armory when a Gothon jumps out, red scaly skin, dark grimy teeth, and a 
        evil clown costume flowing around his hate filled body. He's blocking the door to the
        ...
        if action == "shoot!":
            ...
            new costume his mother bought him, which makes him fly into an insane rage and blast
            ...
            print(dedent("""
            Lucky for you they made you 1earn Gothon insults in the academy. You tell the
...
class LaserWeaponArmory(Scene):
    def enter(self):
        print(dedent("""
        You do a dive poll into the Weapon Armory, crouch and scan the room for more
...
class TheBridge(Scene):
    def enter(self):
        ...
        uglier clown costume than the last. They haven't pulled their weapons out yet, 
        ...
        if action == "throw the bomb":
            ...
            Right as you drop it a Gothon shoots you right in the back killing you. As you die
            see another Gothon frantically try to disarm the bomb. You die knowing they will
...
class EscapePod(Scene):
    def enter(self):
        print(dedent("""
        You rush through the ship desperately tring to make it to escape pod before
        the whole ship explodes. It seems like hardly any Gothons are on the ship, 
        ...
        if int(guess) != good_pod:
            ...
            look back and see your ship implode the explode like a bright star, taking 
